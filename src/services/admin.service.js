...
export const assignOperator = async (bookingId, operatorId) => {
  ...
  // 4. Atomic transaction: booking gets dispatched, operator.availability = busy, tractor = busy
...
export const getAllPayments = async (query = {}) => {
  ...
  const paymentWhere = {};
  const bookingWhere = { status: { not: 'paid' } };
...
export const getDashboardMetrics = async () => {
  ...
  return {
    ...
    pending_dispatch: pendingAssignments,
